 ...
 */
int _myexit(information_t *info)
{
	int exitcheck;
 ...
 *  Return: Always 0
 */
int _myhistory(information_t *infos)
{
	print_lst(infos->history);
	return (0);
}
 ...
 */
int unset_alias(information_t *infos, char *str)
{
	char *p, c;
	int ret;
 ...
 *  Return: Always 0
 */
int _myalias(information_t *info)
{
	int i = 0;
	char *p = NULL;
	lst_t *node = NULL;
